...
"""
Prediction Net from: https://github.com/coxlab/prednet
- data is normalized to [0, 1]..default max_pix value is 1
- network input: (batch_size, timestep, rows, cols, channels) -> (num seq, images per seq, rows, cols, channels)
"""
...
def load_model_cont(arguments, checkpoint_path, extrap_time=0):
    """
...
def load_model(checkpoint_path, look_back, output_mode='prediction', extrap_time=0):
    """
